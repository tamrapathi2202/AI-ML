...
color: black;
background: qlineargradient(y1:0, y2:1,stop:0 #c4a000, stop:1 #fce94f);
font-weight: bold;       
        }
        QPushButton
        {
            ...
            border-radius: 0px;
            width: 70px;
            background-color: qlineargradient(y1:0, y2:1, stop:0 #729fcf, stop:1 #eeeeec);
        } 
        ...
        QPushButton::hover
        {
            ...
            color: #ECECEC; 
            border-radius: 0px;
            background-color: qlineargradient(y1:0, y2:1, stop:0 #A7CEFF, stop:1 #556782);
        } 
        QPushButton::action
        {
            color: #ECECEC; 
            background-color: qlineargradient(y1:0, y2:1, stop:0 #ef2929, stop:1 #a40000);
        } 
        QToolButton
        {
            height: 20px;
        ...
        {
            color: #ECECEC; 
            background-color: qlineargradient(y1:0, y2:1, stop:0 #204a87, stop:1 #ececec);
        } 
...
if __name__ == '__main__':
    ...
    if len(sys.argv) > 1:
        url = os.path.basename('Speaker30_006')
        player = Player(None)
        print(url)
